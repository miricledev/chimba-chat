...
const AdminStoryCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create story
      const storyResponse = await axios.post('/api/admin/stories', story);
      const storyId = storyResponse.data.id;

      // Create messages
      await Promise.all(messages.map(message => 
        axios.post(`/api/admin/stories/${storyId}/messages`, message)
      ));
...
export default AdminStoryCreate; 